  ...
  methods: {
    handleAccountLogin() {
      ...
      if (this.account && this.password) {
        ...
        axios
          .post(
            "http://43.140.252.215:8080/music/login/loginByPassword/" +
              this.account +
              "/" +
              this.password
          )
    ...
    getCaptcha() {
      ...
      if (!this.account) {
        ...
        axios
          .get(
            "http://43.140.252.215:8080/music/login/sendVerifyCodeForLogin/" +
              this.account
          )
          .then((res) => {
            console.log(res);
    ...
    handleCodeLogin() {
      ...
      if (this.account && this.captcha) {
        ...
        axios
          .post(
            "http://43.140.252.215:8080/music/login/doVerifyCodeForLogin/" +
              this.account +
              "/" +
              this.captcha
          )
