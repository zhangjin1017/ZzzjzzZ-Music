...
export default {
  ...
  methods: {
    ...
    getCaptcha() {
      ...
      axios.get('https://43.140.252.215:80/music/login/sendVerifyCodeForRegister/'+this.account).then(res => {
        console.log(res)
    ...
    Register() {
      ...
      if (this.account && this.password && this.repassword && this.captcha) {
        ...
        axios.post('https://43.140.252.215:80/music/login/doVerifyCodeForRegister/'
