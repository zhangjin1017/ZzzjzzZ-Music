  ...
  methods: {
    ...
    async getData() {
      ...
      this.listError = false
       ...
       await axios.get("https://43.140.252.215:80/music/playlist/getPlaylistById/" + JSON.parse(localStorage.getItem("userInfo")).userId).then(res => {
     ...
     async renderPlaylist(data) {
      ...
      await axios.get("https://43.140.252.215:80/music/details/getDetailsById/"+data.id).then(res => {
